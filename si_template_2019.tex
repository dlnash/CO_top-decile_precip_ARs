...
\begin{figure}
\noindent\includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{figS4.png}
\caption{The non-landfalling AR trajectory frequency (shading; count) for the (a) Upper Yampa, (b) Roaring Fork, (c) Upper Gunnison, and (d) Upper San Juan subbasins (white contours) for all months from 2000 to 2023. The backwards trajectories for the (e) Upper Yampa, (f) Roaring Fork, (g) Upper Gunnison, and (h) Upper San Juan subbasins (black contours) for all months from 2000 to 2023 that were not associated with a landfalling AR.}
